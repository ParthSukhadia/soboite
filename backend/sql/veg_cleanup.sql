...
SET name = 'Paneer Bhurji Pav',
    ...
    image_storage_url = 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?auto=format&fit=crop&q=80&w=800'
WHERE name = 'Kheema Pav';

UPDATE dishes
SET name = 'Veg Dhansak',
    review = 'Lentils with seasonal veggies and rice.',
    image_storage_url = 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&q=80&w=800'
WHERE name = 'Chicken Dhansak';

UPDATE dishes
SET name = 'Veg Burger',
    review = 'Crisp veg patty with house sauce.',
    image_storage_url = 'https://images.unsplash.com/photo-1482049016688-2d3e1b311543?auto=format&fit=crop&q=80&w=800'
...
UPDATE restaurants
SET image_storage_url = 'https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&q=80&w=800'
WHERE name = 'Pizza By The Bay';

UPDATE restaurants
SET image_storage_url = 'https://images.unsplash.com/photo-1466978913421-dad2ebd01d17?auto=format&fit=crop&q=80&w=800'
